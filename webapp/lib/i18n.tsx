...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "new.pdfHint": "Extracts the text in your browser, then DeepSeek auto-fills the type, metadata and card body. Review before submitting.",
  ...
  zh: {
    ...
    "new.pdfHint": "在浏览器里提取全文，再由 DeepSeek 自动判定类型、填好元数据与正文。提交前请核对。",
