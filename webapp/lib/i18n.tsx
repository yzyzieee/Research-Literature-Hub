...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "new.title": "New card",
    "new.subtitle": "Fill in metadata → (optional) draft the body with DeepSeek → open a PR into 90_pending for human review.",
    "new.type": "Card type",
  ...
  zh: {
    ...
    "new.title": "新建卡片",
    "new.subtitle": "填写元数据 →（可选）用 DeepSeek 起草正文 → 提交 PR 进入 90_pending 等待人工审核。",
    "new.type": "卡片类型",
