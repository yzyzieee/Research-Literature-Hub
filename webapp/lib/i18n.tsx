...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "pending.subtitle": "Drafts in 90_pending. Review happens in GitHub PRs — the LLM only assists; a human is the final academic judge.",
    ...
    "new.title": "New card",
    "new.subtitle": "Upload a PDF for auto-extraction, or fill metadata manually → review → open a PR into 90_pending for human review.",
    ...
    "new.driveAuto": "After choosing a PDF, click “Upload to Drive” to push it straight to the shared folder — the Drive link fills in automatically.",
    ...
    "new.submitPr": "Open PR into 90_pending",
  ...
  zh: {
    ...
    "pending.title": "审核队列",
    "pending.subtitle": "90_pending 中的草稿卡。审核在 GitHub PR 中进行——LLM 只辅助，人是最终学术裁判。",
    ...
    "new.title": "新建卡片",
    "new.subtitle": "上传 PDF 自动解析，或手动填写元数据 → 审核 → 提交 PR 进入 90_pending 等待人工审核。",
    ...
    "new.driveAuto": "选好 PDF 后点“上传到 Drive”，文件直接传入共享文件夹，Drive 链接会自动填好。",
    ...
    "new.drafting": "起草中…",
    "new.blank": "插入空白模板",
    "new.submitPr": "提交 PR 到 90_pending",
    "new.submitting": "提交中…",
    "new.download": "下载 .md",
