...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "review.subtitle": "Rate papers already in the official library. Your latest score replaces your previous score under the same name.",
  ...
  zh: {
    ...
    "review.title": "团队文献评分",
    "review.subtitle": "对已经进入正式库的论文评分。同一姓名再次提交时，会替换自己之前的评分。",
    "review.formula": "文献权重",
